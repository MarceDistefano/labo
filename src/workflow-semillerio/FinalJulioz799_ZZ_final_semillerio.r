...
PARAM  <- list()
PARAM$experimento  <- "FINAL_JULIOZZ7990KAGGLE"
PARAM$exp_input  <- "FINAL_JULIO_HT_KAGGLE"
...
PARAM$semilla_primos  <- 211283   # se utiliza para generar el vector de  PARAM$semillerio  semillas
