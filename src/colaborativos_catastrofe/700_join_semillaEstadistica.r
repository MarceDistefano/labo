...
dataset_pred1 <- fread ("~/buckets/b1/exp/ZZ6912Estadistica_semilla1/pred_01_043.csv")
...
dataset_pred2 <- fread ("~/buckets/b1/exp/ZZ6912Estadistica_semilla2/pred_01_043.csv")
...
dataset_pred3 <- fread ("~/buckets/b1/exp/ZZ6912Estadistica_semilla3/pred_01_043.csv")
...
dataset_pred4<- fread ("~/buckets/b1/exp/ZZ6912Estadistica_semilla4/pred_01_043.csv")
...
dataset_pred5 <- fread ("~/buckets/b1/exp/ZZ6912Estadistica_semilla5/pred_01_043.csv")
