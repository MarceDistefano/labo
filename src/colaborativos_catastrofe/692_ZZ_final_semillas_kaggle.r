...
PARAM  <- list()
PARAM$experimento  <- "ZZ6920_Estadistico<kaggle"
PARAM$exp_input  <- "HT6510Estadistico_kaggle"
...
PARAM$semillas  <- c( 211283, 586909, 192991, 473167, 883343 ) #reemplazar por las propias semillas
